                      ...
                      {exchanges
                        ...
                        .map((exchange) => (
                          <tr key={exchange.id}>
                            ...
                            <td>{exchange.requester_name + " " + exchange.requester_lname}</td>
                            <td>
                              <Badge
                                bg={
                    ...
                    <tbody>
                      {sentRequests.map((exchange) => (
                        <tr key={exchange.id}>
                          ...
                          <td>{exchange.owner_name + " " + exchange.owner_lname}</td>{" "}
                          ...
                          <td className="text-muted">
                            <small>{new Date(exchange.created_at).toLocaleDateString()}</small>
                          </td>
                          <td>
                            <Button
                              variant="outline-info"
